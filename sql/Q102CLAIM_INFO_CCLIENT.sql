CREATE TABLE CLAIM_PRIZE_INFO_CCLIENT 
(
...
, ORGANIZATION_TYPE VARCHAR2(8 BYTE) 
...
, CONSTRAINT CLAIM_PRIZE_INFO_CCLIENT_PK PRIMARY KEY 
  (
    ID 
  )
  USING INDEX 
  (
      CREATE UNIQUE INDEX CLAIM_PRIZE_INFO_CCLIENT_PK ON CLAIM_PRIZE_INFO_CCLIENT (ID ASC) 
      LOGGING 
