CREATE TABLE CLAIM_PRIZE_INFO_ALL 
(
...
, CONSTRAINT CLAIM_PRIZE_INFO_ALL_PK PRIMARY KEY 
  (
    ID 
  )
  USING INDEX 
  (
      CREATE UNIQUE INDEX CLAIM_PRIZE_INFO_ALL_PK ON CLAIM_PRIZE_INFO_ALL (ID ASC) 
      LOGGING 
