CREATE TABLE CLAIM_PRIZE_INFO_CENTER 
(
...
, CONSTRAINT CLAIM_PRIZE_INFO_CENTER_PK PRIMARY KEY 
  (
    ID 
  )
  USING INDEX 
  (
      CREATE UNIQUE INDEX CLAIM_PRIZE_INFO_CENTER_PK ON CLAIM_PRIZE_INFO_CENTER (ID ASC) 
      LOGGING 
