CREATE TABLE CLAIM_PRIZE_INFO_STORE 
(
...
, CONSTRAINT CLAIM_PRIZE_INFO_STORE_PK PRIMARY KEY 
  (
    ID 
  )
  USING INDEX 
  (
      CREATE UNIQUE INDEX CLAIM_PRIZE_INFO_STORE_PK ON CLAIM_PRIZE_INFO_STORE (ID ASC) 
      LOGGING 
