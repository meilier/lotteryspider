...
class LotteryDatabase:
	...
	__conn = 0
	__cursor = 0
	JX201SQL = "INSERT INTO T_PHONE_LOTTERY_TICKET_ALL (ID, SITE_CODE, SITE_NAME, SPORTS_LOTTERY_CODE, SPORTS_LOTTERY_NAME, ACTIVE_NUMBER, ACTIVE_MONEY, SURE_NUMBER, SURE_MONEY, DUIJIANG_NUMBER, DUIJIANG_MONEY, MANAGE_DATE) VALUES "
