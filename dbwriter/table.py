...
class AllotDataTable(Table):
	...
	@property
	def insert_sql(self):
		return "INSERT INTO ALLOT_DATA (ALLOT_NUMBER, OUTBOUND_WAREHOUSE, INBOUND_WAREHOUSE, GAME_CODE, GAME_NAME, ALLOT_CASE_NUMBER, ALLOT_SCATTERED_PACKAGE, ALLOT_TOTAL_PACKAGE, GAME_FACE_VALUE， ALLOT_TOTAL_MONEY, MANAGE_DATE) VALUES "
